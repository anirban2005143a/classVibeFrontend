...
const verifyEmail = () => {
    ...
    return (
        <>
            ...
            {isValid && <div className=' w-100 h-100 position-absolute d-flex justify-content-center align-items-center'>
                <div className="verifyContainer overflow-auto rounded-3 bg-body-tertiary d-flex flex-column align-items-center">
                    <div className="svgIcon w-100 h-auto d-flex justify-content-center text-center">
                        <div className={`mt-2 svg ${isScaled ? 'scaleup' : 'scaledowmn'} `}>
